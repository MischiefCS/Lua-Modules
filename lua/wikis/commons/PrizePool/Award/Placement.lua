...
function AwardPlacement:_getLpdbData(...)
	...
	for _, opponent in ipairs(self.opponents) do
		...
		local lpdbData = {
			...
			individualprizemoney = playerShare and (playerShare / Opponent.partySize(opponentType))
    			or (Opponent.typeIsParty(opponentType) and (prizeMoney / Opponent.partySize(opponentType)) or 0),
			...
			extradata = {
				...
				participantteam = (opponentType == Opponent.solo and players.p1team)
									...
									or nil,
				playershare = playerShare or nil,
			},
